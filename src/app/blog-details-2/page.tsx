                  ...
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    <div>
                      <div>
                        ...
                        <ul>
                          <li>
                            It is hard to determine the best career suited for
                            my skills
                          </li>
                          <li>
                            It is hard to narrow down viable career options
                          </li>
                          <li>
                            Not aware of what all of the career options are
                          </li>
                          <li>
                            Do not know the difference between different roles
                          </li>
                        </ul>
                        <p>
                          <strong>
                            Even if you do not know your dream career, do you
                            have some idea of what type of career you would like
                            to pursue? This could be related to the work
                            industry, job tasks, work environment or general
                        ...
                        <p>
                          <strong>
                            Do you or have you used any tools to help you
                            identify your dream career? If Yes, what tools did
                            you use? If No, do you know of any tools that you
                            could use?
                          </strong>
                        </p>
                        <ul>
                        ...
                        <ul>
                          ...
                          <li>
                            Provide examples of what other people with a similar
                            skill set are doing
                          </li>
                        </ul>
                        <p>
                          <strong>
                            Are there any additional features you wished the
                            tools provided that would help you identify your
                            dream career?
                          </strong>
                        </p>
                        <ul>
                          <li>
                            If you could put in a job position and the tool
                            would provide you with the next step, journey of the
                            career and skills that you would need
                          </li>
                          <li>
                            If the tool told you what skills would be required
                            along the career path
                          </li>
                          <li>
                            Can filter for types of jobs based on their
                            degree/skills
                          </li>
                        </ul>
                      </div>
                      ...
                      <div>
                        ...
                        <ul>
                          <li>
                            Not having the time and resources to build the
                            required skills
                          </li>
                        </ul>
                        <p>
                        ...
                        <ul>
                          <li>
                            No they believe that they will need to build skills
                          </li>
                        </ul>
                        <p>
                          <strong>
                        ...
                        <ul>
                          <li>
                            Coop and academics are pretty much their only
                        ...
                        <p>
                          <strong>
                            Are there any additional features you wished the
                            tools provided that would help you pursue your dream
                            career?
                          </strong>
                        </p>
                      </div>
...
export default BlogDetailsPage2;
