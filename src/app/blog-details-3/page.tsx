              ...
              <div>
                ...
                <div>
                  <div>
                    ...
                    <p>
                      <strong>
                        ...
                        pursue? This could be related to the work industry, job
                        tasks, work environment or general career
                        characteristics.
                      </strong>
                    </p>
                    <ul>
                    ...
                    <ul>
                      ...
                      <li>
                        Have a mandatory Grade 10 course, Civics and Careers,
                        that teaches students about possible pathways and
                        building resumes, cover letters and interview skills
                      </li>
                    </ul>
                    <p>
                      <strong>
                    ...
                    <ul>
                      <li>
                        ...
                        careers, whether that be online meetings and job
                        shadowing
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <p>
                      <strong>
                        Do you think you have the required skills and resources
                        to pursue your dream career?
                      </strong>
                    </p>
                    <ul>
                      <li>
                        Blueprint and Civics and Careers helps, but is not
                        enough
                      </li>
                      <li>
                    ...
                    <p>
                      <strong>
                        ...
                        your dream career? If Yes, what tools do or did you use?
                      </strong>
                    </p>
                    <ul>
                    ...
                    <ul>
                      <li>
                        More opportunity for exploration as throughout the
                        course we are asked to choose on career field which
                        feels like I am being boxed into one future at a young
                        age
                      </li>
                    </ul>
                  </div>
...
export default BlogDetailsPage3;
